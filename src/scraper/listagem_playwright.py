...
class ListagemScraperPlaywright:
    ...
    async def extract_all_pedidos(self, last_order_id: Optional[int] = None) -> List[Dict]:
        ...
        DebugHelper.log_step("extract_all_pedidos_start", {"last_order_id": last_order_id})
